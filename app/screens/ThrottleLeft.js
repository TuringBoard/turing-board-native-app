...
export default function ThrottleLeft() {
    ...
    let offsetLeft = 40
    let startingX = -offsetLeft
    let startingY = 300
    let rx = 300
    let ry = 300
    let xEnd = rx - offsetLeft
    let yEnd = 300 + ry
    ...
    */}
    ...
    const panGestureEvent = useAnimatedGestureHandler({
        ...
        onActive: (event, context) => {
            theta.value = Math.atan((-event.translationY - context.translateY) / (rx - offsetLeft + event.translationX - context.translateX))
            if (theta.value * 180 / Math.PI < 0 && translateY.value <= 0) {
                theta.value = 0
            }
            translateX.value = (rx * Math.cos(theta.value)) - rx
            translateY.value = -((rx) * Math.sin(theta.value));
            runOnJS(speedHandler)(theta.value)
        },
        onEnd: (event) => {
            translateX.value = (rx * Math.cos(10 * Math.PI / 180)) - rx
        ...
        <View>
            ...
            <Text
                style={{
                    ...
                    position: 'absolute',
                    right: 30,
                    top: Platform.OS === "android" ? phoneWidth <= 375 || phoneHeight === 736 ? 240 - offsetTop : 260 - offsetTop : phoneWidth <= 375 || phoneHeight === 736 ? 240 : 260
                }}
            >
            ...
            <Text style={{
                ...
                fontSize: 80,
                position: 'absolute',
                top: Platform.OS === "android" ? phoneWidth <= 375 || phoneHeight === 736 ? 150 - offsetTop : 170 - offsetTop : phoneWidth <= 375 || phoneHeight === 736 ? 150 : 170,
                textAlign: 'center',
                right: 25,
                fontFamily: 'Avenir-Book'
            ...
            <Text
                style={{
                    ...
                    color: 'white',
                    position: 'absolute',
                    top: Platform.OS === "android" ? phoneWidth <= 375 ? 315 - offsetTop : 335 - offsetTop : phoneWidth <= 375 ? 315 : 335,
                    textAlign: 'center',
                    right: phoneWidth <= 375 ? 15 : phoneWidth <= 390 || phoneWidth <= 414 ? 18 : 57,
                    fontFamily: 'Avenir-Book',
                    opacity: 0.6
                }}
            >Tap to change</Text>
            ...
            <SafeAreaView style={{
                ...
                <Svg height={phoneHeight} width={phoneWidth}>
                    ...
                    <Path d={`M ${startingX} ${startingY}
                         A ${rx} ${ry} 0 0 1 ${xEnd} ${yEnd}
                        `}
                        stroke="url(#strokePath)" fill="none" strokeWidth={trackStrokeWidth} />
                    { /* Debugging circle */}
                    {/* <Circle cx={rx - offsetLeft} cy={yEnd - 10} r={10} fill="red" /> */}
                    <Path d={`M ${startingX} ${startingY - outerOffsets}
                         A ${rx + outerOffsets} ${ry + outerOffsets} 0 0 1 ${xEnd + outerOffsets} ${yEnd + 35}
                        `}
                        stroke="white"
                        fill="none"
                        strokeWidth={2}
                    ...
                    <Path d={`M ${startingX} ${startingY + innerOffsets}
                         A ${rx - innerOffsets} ${ry - innerOffsets} 0 0 1 ${xEnd - innerOffsets} ${yEnd}
                        `}
                        stroke="white"
                        fill="none"
                        strokeWidth={2}
                    ...
                    />
                    <SvgText
                        x={outerCircumferenceStart + ((outerRadius) - ((outerRadius - 10) * Math.cos(99.6 * Math.PI / 180))) - 10}
                        y={yEnd - (outerRadius - 10) * Math.sin(99.6 * Math.PI / 180) + 215}
                        fill="white"
                        fontSize="20"
                        key="F"
                    >
                    ...
                    <SvgText fill="white" fontSize="15" >
                        <TextPath href="#outerLinePath" startOffset="101%" side="right">
                    ...
                    </SvgText>
                    {
                        fuelAngles.map((angle, index) => {
                            return <Line
                                x1={innerCircumferenceStart + (innerRadius - (innerRadius * Math.cos((180 - angle) * Math.PI / 180)))}
                                y1={yEnd - innerRadius * Math.sin((180 - angle) * Math.PI / 180)}
                                x2={innerCircumferenceStart + ((innerRadius) - ((innerRadius - 10) * Math.cos((180 - angle) * Math.PI / 180)))}
                                y2={yEnd - (innerRadius - 10) * Math.sin((180 - angle) * Math.PI / 180)}
                                stroke="white"
                                strokeWidth="2"
                                key={index + 9009}
                    ...
                    <Line
                        x1={innerCircumferenceStart + (innerRadius - (innerRadius * Math.cos(140 * Math.PI / 180)))}
                        y1={yEnd - innerRadius * Math.sin(140 * Math.PI / 180)}
                        x2={innerCircumferenceStart + ((innerRadius) - ((innerRadius + 10) * Math.cos(140 * Math.PI / 180)))}
                        y2={yEnd - (innerRadius + 10) * Math.sin(140 * Math.PI / 180)}
                        stroke="white"
                        strokeWidth="2"
                        key={2 + 90090}
                    />
                    ...
                    <Line
                        x1={outerCircumferenceStart + (outerRadius - (outerRadius * Math.cos(170 * Math.PI / 180)))}
                        y1={yEnd - outerRadius * Math.sin(170 * Math.PI / 180)}
                        x2={outerCircumferenceStart + ((outerRadius) - ((outerRadius - 10) * Math.cos(170 * Math.PI / 180)))}
                        y2={yEnd - (outerRadius - 10) * Math.sin(170 * Math.PI / 180)}
                        stroke="white"
                        strokeWidth="2"
                        key={0}
                    />
                    <SvgText
                        x={outerCircumferenceStart + ((outerRadius) - ((outerRadius - 10) * Math.cos(170 * Math.PI / 180))) - 10}
                        y={yEnd - (outerRadius - 10) * Math.sin(170 * Math.PI / 180) + 15}
                        fill="white"
                        fontSize="15"
                        key={`${0}${10}`}
                    >
...

                    {
                        innerAngles.map((angle, index) => {
                            return <G key={`${index + 2}${angle}`}>
                                <Line
                                    x1={outerCircumferenceStart + (outerRadius - (outerRadius * Math.cos((180 - angle) * Math.PI / 180)))}
                                    y1={yEnd - outerRadius * Math.sin((180 - angle) * Math.PI / 180)}
                                    x2={outerCircumferenceStart + ((outerRadius) - ((outerRadius - 10) * Math.cos((180 - angle) * Math.PI / 180)))}
                                    y2={yEnd - (outerRadius - 10) * Math.sin((180 - angle) * Math.PI / 180)}
                                    stroke="white"
                                    strokeWidth="2"
                                    key={index}
                                />
                                <SvgText
                                    x={outerCircumferenceStart + ((outerRadius) - ((outerRadius - 10) * Math.cos((180 - angle) * Math.PI / 180))) - 10}
                                    y={yEnd - (outerRadius - 10) * Math.sin((180 - angle) * Math.PI / 180) + 15}
                                    fill="white"
                                    fontSize="15"
                                    key={`${index + 1}${(180 - angle)}`}
                                >
                                    {nums[index]}
                                </SvgText>
                            </G>
                ...
                >
                    <Animated.View
                        style={[{
                            ...
                            right: phoneWidth - xEnd - trackStrokeWidth / 2,
                ...
                <View style={{
                    ...
                    right: phoneWidth - xEnd - offsetLeft + 4,
                    borderRadius: 0,
                    transform: [
                        {
                            rotate: "170deg" // 10 * (Math.PI / 180) because Android is stupid 
                        }
                    ]
                }}>
                </View>
                <TouchableOpacity
                    style={{
                        ...
                        position: 'absolute',
                        right: phoneWidth <= 390 || phoneWidth <= 414 ? 25 : 65,
                        top: Platform.OS === "android" ? phoneWidth <= 375 ? startingY + 40 - offsetTop : startingY + 60 - offsetTop : phoneWidth <= 375 ? startingY + 40 : startingY + 60,
                        flex: 1,
                        justifyContent: 'center',
                        borderColor: 'white',
                        borderWidth: 3
